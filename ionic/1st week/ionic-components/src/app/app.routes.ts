...
export const routes: Routes = [
  ...
  },
  {
    path: "toolbars",
    loadComponent: () =>
      import("./toolbars/toolbars.page").then((m) => m.ToolbarsPage),
  },
  {
    path: "horizontal-scroll",
    loadComponent: () =>
      import("./horizontal-scroll/horizontal-scroll.page").then(
        (m) => m.HorizontalScrollPage
      ),
  },
  {
    path: "toast",
  ...
  },
  {
    path: "refresher",
    loadComponent: () =>
      import("./refresher/refresher.page").then((m) => m.RefresherPage),
  },
  {
    path: "infinite-scroll",
    loadComponent: () =>
      import("./infinite-scroll/infinite-scroll.page").then(
  ...
  },
  {
    path: "segment",
    loadComponent: () =>
      import("./segment/segment.page").then((m) => m.SegmentPage),
  },
  {
    path: "slides",
    loadComponent: () =>
  ...
  },
  {
    path: "virtual-scroll",
    loadComponent: () =>
      import("./virtual-scroll/virtual-scroll.page").then(
  ...
  },
  {
    path: "gestures",
    loadComponent: () =>
      import("./gestures/gestures.page").then((m) => m.GesturesPage),
  },
  {
    path: "skeleton",
    loadComponent: () =>
      import("./skeleton/skeleton.page").then((m) => m.SkeletonPage),
  },
  {
    path: "modal",
